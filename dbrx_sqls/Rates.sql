SELECT
  ...
  Derived.SingleorMultiCurrency,
  Derived.CFIDeliveryType,
  Derived.ShortName,
  Derived.UnderlierName,
  Derived.Attributes.NotionalCurrency,
  Derived.Attributes.ReferenceRate,
  Derived.Attributes.ReferenceRateTermValue,
  Derived.Attributes.ReferenceRateTermUnit,
  Derived.Attributes.OtherNotionalCurrency,
  Derived.Attributes.OtherLegReferenceRate,
  Derived.Attributes.OtherLegReferenceRateTermValue,
  Derived.Attributes.OtherLegReferenceRateTermUnit,
  Derived.Attributes.NotionalSchedule,
  Derived.Attributes.DeliveryType,
